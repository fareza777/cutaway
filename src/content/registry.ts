...
const ENTRIES: Entry[] = [
  { doc: require('../../content/smartphone.json') as ObjectDoc, model: require('../../assets/models/smartphone.glb') },
  { doc: require('../../content/turbofan.json') as ObjectDoc, model: require('../../assets/models/turbofan.glb') },
  {
  ...
  { doc: require('../../content/lock.json') as ObjectDoc, model: require('../../assets/models/lock.glb'), translations: { id: require('../../content/id/lock.json') } },
  { doc: require('../../content/loudspeaker.json') as ObjectDoc, model: require('../../assets/models/loudspeaker.glb'), translations: { id: require('../../content/id/loudspeaker.json') } },
  {
  ...
  { doc: require('../../content/differential.json') as ObjectDoc, model: require('../../assets/models/differential.glb'), translations: { id: require('../../content/id/differential.json') } },
  { doc: require('../../content/camera.json') as ObjectDoc, model: require('../../assets/models/camera.glb'), translations: { id: require('../../content/id/camera.json') } },
  { doc: require('../../content/violin.json') as ObjectDoc, model: require('../../assets/models/violin.glb'), translations: { id: require('../../content/id/violin.json') } },
  { doc: require('../../content/brain.json') as ObjectDoc, model: require('../../assets/models/brain.glb'), translations: { id: require('../../content/id/brain.json') } },
  {
  ...
  { doc: require('../../content/tooth.json') as ObjectDoc, model: require('../../assets/models/tooth.glb'), translations: { id: require('../../content/id/tooth.json') } },
];
