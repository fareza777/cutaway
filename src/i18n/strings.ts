...
const en = {
  ...
  'library.footer': '{count} objects · works offline · contains ads',
  'library.search': 'Search objects…',
  'library.clearSearch': 'Clear search',
  'library.results': 'Objects found: {count}',
  'library.noResults': 'No matching objects',
  'library.searchHint': 'Try another name or change the category.',
  'library.resetSearch': 'Show all objects',
  'settings.adPrivacy': 'Ad privacy choices',
  'settings.adPrivacyFailed': 'Privacy choices could not be opened. Please try again.',
  ...
  'settings.removeAdsHint': 'One-time purchase. Removes banners and full-screen ads on this device.',
  ...
  'settings.shareMessage': 'Take apart 3D objects and see how they work — Cutaway: {link}',
  'settings.linkFailed': 'Could not open. Please try again.',
  'settings.privacy': 'Privacy policy',
  'settings.about': 'The core library works offline without an account. Ads support new objects. See the privacy policy for how advertising services process data.',
...
const id: Record<Key, string> = {
  ...
  'library.footer': '{count} objek · tanpa internet · mengandung iklan',
  'library.search': 'Cari objek…',
  'library.clearSearch': 'Hapus pencarian',
  'library.results': 'Objek ditemukan: {count}',
  'library.noResults': 'Objek tidak ditemukan',
  'library.searchHint': 'Coba nama lain atau ganti kategori.',
  'library.resetSearch': 'Tampilkan semua objek',
  'settings.adPrivacy': 'Pilihan privasi iklan',
  'settings.adPrivacyFailed': 'Pilihan privasi belum dapat dibuka. Silakan coba lagi.',
  ...
  'settings.removeAdsHint': 'Pembelian satu kali. Menghapus banner dan iklan layar penuh di perangkat ini.',
  ...
  'settings.rate': 'Beri nilai aplikasi ini',
  'settings.share': 'Bagikan aplikasi ini',
  'settings.shareMessage': 'Bongkar objek 3D dan lihat cara kerjanya — Cutaway: {link}',
  'settings.linkFailed': 'Tidak dapat dibuka. Silakan coba lagi.',
  'settings.privacy': 'Kebijakan privasi',
  'settings.about': 'Pustaka utama dapat digunakan tanpa internet dan tanpa akun. Iklan membantu pengembangan objek baru. Lihat kebijakan privasi untuk penjelasan pemrosesan data oleh layanan iklan.',
